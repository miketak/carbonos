...
public record InventoryResponse(UUID id, UUID organizationId, String name, LocalDate periodStart,
		...
		GwpSet gwpSet, StraddleTreatment straddleTreatment, String periodLabel,
	...
	public static InventoryResponse from(Inventory inventory) {
		return new InventoryResponse(inventory.getId(), inventory.getOrganization().getId(), inventory.getName(),
				...
				inventory.getStraddleTreatment(), inventory.periodLabel(), inventory.getScope3Categories(), inventory.getScope3ExclusionsRationale(),
