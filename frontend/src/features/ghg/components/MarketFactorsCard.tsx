...
/**
 * Market-based scope 2 (spec 07.1, Scope 2 Guidance): a contractual instrument
 * per facility for this inventory's period. When any exists, the report shows
 * scope 2 location-based and market-based side by side.
 */
    ...
    set.mutate(
      {
        ...
        input: { instrumentType: instrument, kgCo2ePerKwh: Number(factor), source },
      },
      {
        onSuccess: (saved) => {
          setFactor('')
