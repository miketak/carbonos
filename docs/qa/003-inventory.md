...
| C8 | Sidebar → **Emission factors** | Sixteen factors; Water supply is filed under "1. Purchased goods and services". The scope column is headed "Suggested scope"; Diesel, Petrol, LPG, Natural gas, the two process factors and Wood pellets carry an "any scope" marker, Grid electricity does not. A "Gases (kg per unit)" column splits each factor, e.g. Diesel `CO₂ 2.6307 · CH₄ 0.0001 · N₂O 0.0001`, Waste to landfill `CO₂ 12.2 · CH₄ 15.5`, Wood pellets ending in `biogenic CO₂ 1,800` | ☐ P ☐ F | |
...
| M6 | Classify **R15** (ANFO in tonnes) | The picker offers the mass factors including **ANFO explosives detonation (/tonne)**; choose it. Scope 1, category **Process emissions**, no conversion preview | ☐ P ☐ F | |
