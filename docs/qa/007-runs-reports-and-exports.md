...
| 4 | Check every page break. | No heading or subheading stands alone at the foot of a page: "By facility", "By legal entity", "By country", "5. Emissions by gas", "6a. Gases outside the scopes (Montreal Protocol)" and "10. Snapshot lines" each sit on the same page as their column header and first row; a table that continues on a new page repeats its heading and column header there. | | |
